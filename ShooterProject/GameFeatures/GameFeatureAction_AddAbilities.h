...
struct FShooterProjectAbilityMapping
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FShooterProjectAttributesMapping
{
	GENERATED_BODY()

	// Ability set to grant
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TSoftClassPtr<UShooterProjectAbilityAttributeSet> AttributeSetType;
...
struct FGameFeatureAbilitiesEntry
{
	...
	UPROPERTY(EditAnywhere, Category="Abilities")
	TArray<FShooterProjectAbilityMapping> GrantedAbilities;

	// List of attribute sets to grant to actors of the specified class 
	UPROPERTY(EditAnywhere, Category="Attributes")
	TArray<FShooterProjectAttributesMapping> GrantedAttributes;
};
